...
class PostTypeIntegration {
    ...
    public function injectBridge(): void {
        // Emits the CPT-list sidebar positioning bridge as pure JS attached
        // ('after') to the bundle. Called from enqueueAssets() at enqueue time
        // (the screen and post type are already validated there). The buffered
        // output is pure JS — wp_add_inline_script() adds its own <script> wrapper.
        ob_start();
        ?>
(function () {
    'use strict';
